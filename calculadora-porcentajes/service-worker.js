// Service Worker para Calculadora de Porcentajes meskeIA
// Versión del cache
const CACHE_NAME = 'meskeia-calc-porcentajes-v1.0.0';
const urlsToCache = [
    './calculadora-porcentajes.html',
    './manifest.json',
    '../icon_meskeia.png',
...
self.addEventListener('install', (event) => {
    console.log('[SW] Instalando Service Worker para Calculadora Porcentajes meskeIA');
        ...
        caches.keys().then((cacheNames) => {
            return Promise.all(
                cacheNames.map((cacheName) => {
                    ...
                    if (cacheName !== CACHE_NAME && cacheName.startsWith('meskeia-calc-porcentajes-')) {
                            ...
                            return new Response(`
                                ...
                                <body>
                                    <div class="offline-container">
                                        ...
                                        <p>No es posible cargar la Calculadora de Porcentajes en este momento.</p>
...
console.log('[SW] Service Worker de Calculadora Porcentajes meskeIA cargado');